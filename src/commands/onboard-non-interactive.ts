 ...
 *
 * This module validates the existing config snapshot and routes local/remote
 * setup without interactive prompts.
 */
...
/** Runs non-interactive onboarding in local or remote mode. */
